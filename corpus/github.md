...
Configure[⁠](#configure)
------------------------
### Enable the GitHub integration[⁠](#enable-the-github-integration)
...
#### GitHub Enterprise options [⁠](#github-enterprise-options)
...
#### Add multiple GitHub organizations[⁠](#add-multiple-github-organizations)
...
### Personal account connection[⁠](#personal-account-connection)
...
### Enable commit linking[⁠](#enable-commit-linking)
...
### Configure GitHub Issues Sync[⁠](#configure-github-issues-sync)
Watch this video to see how GitHub Issues sync works:
[![](https://webassets.linear.app/images/ornj730p/production/5f3c96a44e55a647f91140906ac41beff871f735-1280x720.jpg?q=95&auto=format&dpr=2)](https://webassets.linear.app/files/ornj730p/production/27bbcb51c07b84bfc28a2fc30eb708612d1e8852.mp4)
Elapsed00:00
Seek to:00:00 / Duration00:00
Remaining−00:00
0.25×0.5×0.75×1×1.25×1.5×1.75×2×
From the *GitHub Issues* section of the [GitHub integration settings](https://linear.app/settings/integrations/github), click the **+** icon, then select the GitHub repo and Linear team to link.
...
Linking Linear issues to GitHub PRs[⁠](#linking-linear-issues-to-github-prs)
----------------------------------------------------------------------------
...
[![](https://webassets.linear.app/images/ornj730p/production/47503a43bfa9564e7eb4872755ceabbeb22bfc8f-1280x720.jpg?q=95&auto=format&dpr=2)](https://webassets.linear.app/files/ornj730p/production/d97ba48f0c5840572625fd4038594b09bf35184a.mp4)
Elapsed00:00
Seek to:00:00 / Duration00:00
Remaining−00:00
0.25×0.5×0.75×1×1.25×1.5×1.75×2×
### Link through pull requests[⁠](#link-through-pull-requests)
**Branch name**Include issue ID in the branch name. Use the *Copy git branch name* action or shortcut `Cmd/Ctrl` + `Shift`  `.` when viewing or highlighting/selecting an issue and paste it into the new branch name in GitHub.
**Issue ID in Pull Request title**Include the Linear issue ID (e.g. ID-123) in the title when creating pull requests.
**Magic word + issue ID**Use a magic word + issue ID in the PR description or title (e.g. `Fixes ENG-123` or `Fixes https://linear.app/workspace/issue/ENG-123/title`). If the issue is unassigned when linking takes place, you will be added as the assignee of the issue.
Linear offers *closing* and *non-closing* magic words for you to customize your workflow. When using a *closing* magic word, Linear will move the issue to *In Progress* when the branch is pushed and *Done* when the commit is merged to the default branch. When using a *non-closing* magic word, the linked PR or commit will still move the issue through other statuses per Workflow settings, but will not automate the issue’s status when the PR or commit merges. Instead, it will only transition the issue through to what’s configured prior to the *On PR or commit merge* event.
The **closing magic words** are: `close, closes, closed, closing fix, fixes, fixed, fixing, resolve, resolves, resolved, resolving, complete, completes, completed, completing, implements, implemented, implementing`*.*
The **non-closing magic words** are: `ref, refs, references, part of, related to, contributes to, toward, towards`*.*
### Link using commits[⁠](#link-using-commits)
...
Link multiple issues[⁠](#link-multiple-issues)
----------------------------------------------
...
Viewing a linked Linear issue[⁠](#viewing-a-linked-linear-issue)
----------------------------------------------------------------
### Remove a PR from an issue[⁠](#remove-a-pr-from-an-issue)
...
### Pull request preview links[⁠](#pull-request-preview-links)
...
PR description textVercel Preview commentsNetlify Preview comments
...
[![](https://webassets.linear.app/images/ornj730p/production/4ca41a90c116a9cf7c73742ef9dfdf19bb957c97-1280x720.jpg?q=95&auto=format&dpr=2)](https://webassets.linear.app/files/ornj730p/production/8a2505bb37058e85139d4715a8568d9318016c5a.mp4)
Elapsed00:00
Seek to:00:00 / Duration00:00
Remaining−00:00
0.25×0.5×0.75×1×1.25×1.5×1.75×2×
You can customize the automation in *Settings > Team > Workflows & automations > Pull request and commit automations.* Since this is a team setting, it must be configured for each team in your workspace.
...
### Custom merge queues[⁠](#custom-merge-queues)
...
### Branch-specific rules[⁠](#branch-specific-rules)
...
[![](https://webassets.linear.app/images/ornj730p/production/9772ce2f3d562af2911ac9a6611b7e2201c2aaf2-1280x720.jpg?q=95&auto=format&dpr=2)](https://webassets.linear.app/files/ornj730p/production/21ec41c5cace62492df29c5cf5ec36138f0600d8.mp4)
Elapsed00:00
Seek to:00:00 / Duration00:00
Remaining−00:00
0.25×0.5×0.75×1×1.25×1.5×1.75×2×
...
### Auto-assign and move issue to start[⁠](#auto-assign-and-move-issue-to-start)
...
If you want to automatically resolve your Linear issue IDs (e.g. *ENG-123*) in PR descriptions or comment to links, you can enable this using GitHub’s *Autolink references* feature. See instructions on [GitHub](https://help.github.com/en/github/administering-a-repository/configuring-autolinks-to-reference-external-resources).
...
GitHub Enterprise Server integration isn't linking pull requests
...
Why is my "Ready for merge" workflow not triggering?
...
Does the GitHub integration support squash merging?
...
How can I unlink a PR from a Linear issue when the branch name includes the issue ID?
...
* [Overview](/docs/github#overview)
* [Permissions](/docs/github#permissions)
* [Configure](/docs/github#configure)
* [Enable the GitHub integration](/docs/github#enable-the-github-integration)
* [GitHub Enterprise options](/docs/github#github-enterprise-options)
* [Add multiple GitHub organizations](/docs/github#add-multiple-github-organizations)
* [Branch format](/docs/github#branch-format)
* [Personal account connection](/docs/github#personal-account-connection)
* [Enable commit linking](/docs/github#enable-commit-linking)
* [Configure GitHub Issues Sync](/docs/github#configure-github-issues-sync)
* [Linking Linear issues to GitHub PRs](/docs/github#linking-linear-issues-to-github-prs)
* [Link through pull requests](/docs/github#link-through-pull-requests)
* [Link using commits](/docs/github#link-using-commits)
* [Link multiple issues](/docs/github#link-multiple-issues)
* [Viewing a linked Linear issue](/docs/github#viewing-a-linked-linear-issue)
* [Remove a PR from an issue](/docs/github#remove-a-pr-from-an-issue)
* [PR review state](/docs/github#pr-review-state)
* [Pull request preview links](/docs/github#pull-request-preview-links)
* [Workflow automation](/docs/github#workflow-automation)
* [Issue status updates](/docs/github#issue-status-updates)
* [Custom merge queues](/docs/github#custom-merge-queues)
* [Branch protection rules](/docs/github#branch-protection-rules)
* [Branch-specific rules](/docs/github#branch-specific-rules)
* [Auto-assign and move issue to start](/docs/github#auto-assign-and-move-issue-to-start)
* [Other settings](/docs/github#other-settings)
* [Linkbacks](/docs/github#linkbacks)
* [Enable Autolink](/docs/github#enable-autolink)
* [FAQ](/docs/github#faq)