# Issue labels – Linear Docs

> **Source:** Northwind Support Copilot corpus  
> **Original URL:** https://linear.app/docs/labels  
> **Document ID:** labels
...
Create labels in [Settings > Workspace > Labels](https://linear.app/settings/labels) page or *Team settings > Labels*.

### Create a label during add label workflow[⁠](#create-a-label-during-add-label-workflow)

You can also create labels in the *Add label* flow. Take the action to apply a label, then type the name of the label you want to create. You will have the option to create the label at the workspace level or for your team.
...
## Reserved label names[⁠](#reserved-label-names)
...
Issue relations](/docs/issue-relations)[Next
