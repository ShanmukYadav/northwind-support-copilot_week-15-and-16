# Project overview – Linear Docs

> **Source:** Northwind Support Copilot corpus  
> **Original URL:** https://linear.app/docs/project-overview  
...
![Project details sidebar view](https://webassets.linear.app/images/ornj730p/production/6f0a51a748dfb751052a8dc0e0b67670c845ab6c-2296x2006.png?w=1440&q=95&auto=format&dpr=2)
...
`details` toopen or close the project details sidebar
...
| Team | Defaults to a single team, but you can add multiple teams. |
...
As well as viewing project properties, documents and link attachments in the project overview, you can also view them in the project details sidebar with `Cmd/Ctrl` `I`  or by clicking on the sidebar button in the top right. You can change all properties from here as well as from the project overview. The project details sidebar is accessible from the project overview and also from the project issues page.
...
Project milestones](/docs/project-milestones)[Next
